...
const NavItems = ({ onClick, navigate, logout }) => 
    <>
      <nav className="p-4 space-y-1">
        ...
        {[
          { label: 'Métricas', icon: <svg viewBox="0 0 24 24"
 fill="none" stroke="currentColor" strokeWidth="1.5" className="w-4 h-4"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg> },
