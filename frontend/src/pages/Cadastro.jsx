...
function Cadastro() {
      ...
      <div className="min-h-screen bg-blue-950 flex items-center justify-center px-4">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <p className="text-blue-200 text-sm">Crie sua conta</p>
          </div>
  ...
  {perfil === 'aluno' ? 'Aluno' : 'Professor'}
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            <div>
              <label className="text-blue-200 text-sm mb-1 block">Nome completo</label>
              <input
                type="text"
                name="nome"
                value={form.nome}
                ...
                required
                className="w-full bg-blue-800 text-white rounded-lg px-4 py-2.5 text-sm outline-none focus:ring-2 focus:ring-orange-400 placeholder-blue-400 border border-blue-700"
              />
            </div>

            <div>
              <label className="text-blue-200 text-sm mb-1 block">Email institucional</label>
              <input
                type="email"
                name="email"
                value={form.email}
            ...
            <button
              type="submit"
              disabled={carregando}
              className="w-full bg-orange-500 hover:bg-orange-600 disabled:opacity-50 text-white font-semibold rounded-lg py-2.5 text-sm transition-colors mt-1"
            >
